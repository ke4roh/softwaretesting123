...
/**
 * This is an interface representing a system for tracking
 * inventory in a store.
 */
public interface InventoryService {
    BigDecimal addStock(String sku, BigDecimal quantity);

    /**
     * @param product
     * @param quantity
     * @return The amount remaining in stock after deducting
     */
    BigDecimal deductStock(Product product, BigDecimal quantity);
}
